...
def main():
    ...
    if flask.request.method == 'POST':
        batting_avg = flask.request.form['batting_avg']
        ...
        sweet_spot = flask.request.form['sweet_spot_percent']
        ...
        input_variables = pd.DataFrame([[batting_avg, k_percent, slg_percent, exit_velocity_avg, launch_angle_avg, sweet_spot,
                                       ...
                                       columns=['batting_avg', 'k_percent', 'slg_percent', 'exit_velocity_avg', 'launch_angle_avg', 'sweet_spot',
                                         'barrel', 'barrel_batted_rate', 'solidcontact_percent', 'flareburner_percent',
                                         'poorlyunder_percent', 'poorlytopped_percent', 'poorlyweak_percent', 'hard_hit_percent',
                                         'avg_best_speed', 'avg_hyper_speed', 'z_swing_percent', 'z_swing_miss_percent',
                                         'oz_swing_percent', 'oz_swing_miss_percent', 'oz_contact_percent', 'meatball_swing_percent',
        ...
        return flask.render_template('web.html', original_input={'batting_avg' : batting_avg, 'k_percent':k_percent, 'slg_percent':slg_percent, 'exit_velocity_avg':exit_velocity_avg, 'launch_angle_avg':launch_angle_avg, 'sweet_spot':sweet_spot,
